  ...
  return (
    <div className="bg-[#121212] min-h-screen text-neutral-200 font-lato">
      <SubpageHero
        ...
        breadcrumb="Marketing Consents"
        subtitle="Manage your marketing communication preferences for Dostana Kebab Lublin."
      />
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-[#161616] border border-white/10 rounded-2xl p-6 sm:p-10 space-y-8 shadow-2xl">
          ...
          <p className="text-sm sm:text-base text-neutral-300 leading-relaxed">
            If you wish to withdraw your marketing consent, we will no longer send you information about promotions and special discounts.
          </p>
...
<div className="pt-2">
              ...
              >
                {submitted ? (
                  <>
                    <Check className="w-4 h-4" /> Unsubscribed Successfully
                  </>
                ) : (
                  "Unsubscribe"
                )}
