  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      if (email === "admin@dostanakebab.com" && password === "admin123") {
        ...
        setError("Niepoprawny e-mail lub hasło. Spróbuj ponownie.");
        setLoading(false);
      }
    }, 1200);
  };
      ...
      <div className="relative z-10 w-full max-w-md space-y-8">
        <div className="text-center space-y-4">
          ...
          <div>
            ...
            <p className="text-sm text-neutral-400 mt-1">
              Zaloguj się, aby zarządzać zamówieniami, lokalami i menu
            </p>
          </div>
        </div>
        ...
        <div className="bg-[#151515] border border-white/10 rounded-3xl p-6 sm:p-8 space-y-6 shadow-2xl">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[10px] text-neutral-500 uppercase tracking-widest">Bezpieczne logowanie</span>
            <div className="flex-1 h-px bg-white/10" />
          </div>
          <div className="flex items-center justify-center gap-2 text-xs text-neutral-500">
            <ShieldCheck className="w-4 h-4 text-emerald-500" />
            <span>Szyfrowanie SSL • Tylko upoważniony personel</span>
          </div>
