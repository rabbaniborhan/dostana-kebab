...
<div className="glass-panel p-6 rounded-2xl border border-white/10 hover:border-[#f26522]/50 transition-all duration-300 flex flex-col justify-between space-y-4 group">
            <div className="space-y-3">
              ...
              <div className="space-y-1">
                <h3 className="font-judson font-bold text-2xl text-white">Where are we?</h3>
            ...
            >
              <span>View All 6 Lublin Locations</span>
...
<div className="glass-panel p-6 rounded-2xl border border-white/10 hover:border-[#f26522]/50 transition-all duration-300 flex flex-col justify-between space-y-4 group">
            <div className="space-y-3">
              ...
              <div className="space-y-1">
                <h3 className="font-judson font-bold text-2xl text-white">Call us</h3>
                <a
...
<div className="glass-panel p-6 rounded-2xl border border-white/10 hover:border-[#f26522]/50 transition-all duration-300 flex flex-col justify-between space-y-4 group">
            <div className="space-y-3">
              ...
              <div className="space-y-1">
                <h3 className="font-judson font-bold text-2xl text-white">Opening hours</h3>
                ...
                <p className="text-[11px] text-neutral-400 pt-1">
                  Fri - Sat: 10:00 AM - 12:00 AM Midnight
                </p>
              </div>
            </div>
            <div className="flex items-center gap-1.5 text-[11px] text-emerald-400 font-bold pt-2 border-t border-white/10">
              <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
              <span>Open Now For Kitchen Orders</span>
            </div>
          </div>
<div className="glass-panel p-6 rounded-2xl border border-[#f26522]/40 bg-[#1c1c1c]/90 flex flex-col justify-between space-y-4 group">
            <div className="space-y-3">
              ...
              <div className="space-y-1">
                <h3 className="font-judson font-bold text-2xl text-white">Order online</h3>
                <p className="text-xs text-neutral-300 leading-relaxed">
                  Fast ordering without login. Pay by cash, card or BLIK.
                </p>
              </div>
            </div>
