        ...
        <div className="w-screen max-w-md bg-neutral-950 border-l border-neutral-800 shadow-2xl flex flex-col justify-between">
          <div className="p-6 border-b border-neutral-800 flex items-center justify-between bg-neutral-900/80">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl font-black text-white">Twój koszyk zamówień</h2>
            </div>
            <button
              onClick={onClose}
              ...
              <span className="text-neutral-300 flex items-center gap-1.5">
                ...
                <span>
                  {amountNeededForFreeDelivery === 0
                    ...
                    : `Dodaj jeszcze ${amountNeededForFreeDelivery.toFixed(2)} zł, aby otrzymać DARMOWĄ dostawę`}
                </span>
              </span>
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-4">
            {cartItems.length === 0 ? (
              <div className="text-center py-20 space-y-4">
                ...
                <h3 className="text-lg font-extrabold text-white">Twój koszyk jest pusty</h3>
                <p className="text-xs text-neutral-400 max-w-xs mx-auto">
                  Wygląda na to, że nie dodałeś jeszcze żadnego pysznego kebaba Dostana. Zobacz nasze menu!
                </p>
                <button
                  onClick={onClose}
                ...
                >
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-neutral-800/80">
                    ...
                    <span className="font-black text-amber-400 text-sm">
                      {cartItem.totalPrice.toFixed(2)} zł
                    </span>
                  </div>
                </div>
              ))
            ...
            <div className="p-6 border-t border-neutral-800 bg-neutral-900 space-y-4">
              <form onSubmit={handleApplyCoupon} className="space-y-1">
                <div className="flex items-center gap-2">
                  <div className="relative flex-1">
                    ...
                    <input
                      ...
                      placeholder="Kod kuponu (np. DOSTANA5)"
                ...
                {appliedPromoCode && (
                  <div className="text-[11px] text-emerald-400 font-bold flex items-center gap-1">
                    <Gift className="w-3.5 h-3.5" /> Kupon &quot;{appliedPromoCode}&quot; aktywny!
                  </div>
                )}
                {promoError && (
              ...
              <div className="space-y-1.5 text-xs text-neutral-400 pt-2 border-t border-neutral-800">
                ...
                <div className="flex justify-between text-base font-black text-white pt-2 border-t border-neutral-800">
                  ...
                  <span className="text-amber-400">{finalTotal.toFixed(2)} zł</span>
                </div>
              </div>
